...
export const findPatient = (patients: any[], searchKey: string, searchValue: string): any | null => {
    const result = patients.find(patient => String(patient[searchKey]).toLowerCase() === searchValue.toLowerCase());
